...
enum SDKErrorCode {
  ...
  resourceNotLoaded(10004, 'Resources not loaded completely, usually uninitialized or login has not completed'),
  ...
  repeatLogin(10102, 'User is attempting to log in again, check the login status to avoid duplicate logins'),
  ...
  serverParameterError(1001, 'Parameter Error on the server, check if body and header parameters are correct'),
