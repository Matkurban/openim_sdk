...
RedPacketGrabInfo _$RedPacketGrabInfoFromJson(Map<String, dynamic> json) =>
    RedPacketGrabInfo(
...
Map<String, dynamic> _$RedPacketGrabInfoToJson(RedPacketGrabInfo instance) =>
    <String, dynamic>{
...
RedPacketDetail _$RedPacketDetailFromJson(Map<String, dynamic> json) =>
    RedPacketDetail(
      ...
      grabs: (json['grabs'] as List<dynamic>)
          .map((e) => RedPacketGrabInfo.fromJson(e as Map<String, dynamic>))
          .toList(),
      myGrabAmount: (json['myGrabAmount'] as num).toDouble(),
    );
