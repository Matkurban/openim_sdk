...
GroupMembersInfo _$GroupMembersInfoFromJson(Map<String, dynamic> json) => GroupMembersInfo(
  groupID: json['groupID'] as String?,
...
Map<String, dynamic> _$GroupMembersInfoToJson(GroupMembersInfo instance) => <String, dynamic>{
  'groupID': instance.groupID,
...
const _$JoinSourceEnumMap = {JoinSource.invited: 2, JoinSource.search: 3, JoinSource.qrCode: 4};

GroupMemberRole _$GroupMemberRoleFromJson(Map<String, dynamic> json) => GroupMemberRole(
  userID: json['userID'] as String?,
  roleLevel: $enumDecodeNullable(
    _$GroupRoleLevelEnumMap,
    json['roleLevel'],
...
Map<String, dynamic> _$GroupMemberRoleToJson(GroupMemberRole instance) => <String, dynamic>{
  'userID': instance.userID,
  'roleLevel': _$GroupRoleLevelEnumMap[instance.roleLevel],
};

GroupApplicationInfo _$GroupApplicationInfoFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$GroupApplicationInfoToJson(GroupApplicationInfo instance) =>
    <String, dynamic>{
      'groupID': instance.groupID,
      'groupName': instance.groupName,
      'notification': instance.notification,
...
GroupInviteResult _$GroupInviteResultFromJson(Map<String, dynamic> json) =>
    GroupInviteResult(userID: json['userID'] as String?, result: (json['result'] as num?)?.toInt());

Map<String, dynamic> _$GroupInviteResultToJson(GroupInviteResult instance) => <String, dynamic>{
  'userID': instance.userID,
  'result': instance.result,
};

GetGroupApplicationListAsRecipientReq _$GetGroupApplicationListAsRecipientReqFromJson(
  Map<String, dynamic> json,
) => GetGroupApplicationListAsRecipientReq(
  groupIDs: (json['groupIDs'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
  handleResults:
      (json['handleResults'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList() ??
      const [],
...
GetGroupApplicationListAsApplicantReq _$GetGroupApplicationListAsApplicantReqFromJson(
  Map<String, dynamic> json,
...
GetGroupApplicationUnhandledCountReq _$GetGroupApplicationUnhandledCountReqFromJson(
  Map<String, dynamic> json,
) => GetGroupApplicationUnhandledCountReq(time: (json['time'] as num?)?.toInt() ?? 0);
