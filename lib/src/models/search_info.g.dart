...
Map<String, dynamic> _$SearchResultItemsToJson(SearchResultItems instance) => <String, dynamic>{
...
SearchParams _$SearchParamsFromJson(Map<String, dynamic> json) => SearchParams(
  conversationID: json['conversationID'] as String?,
  clientMsgIDList: (json['clientMsgIDList'] as List<dynamic>?)?.map((e) => e as String).toList(),
);
