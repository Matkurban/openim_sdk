...
Message _$MessageFromJson(Map<String, dynamic> json) => Message(
  ...
  callSignalElem: json['callSignalElem'] == null
      ? null
      : CallSignalElem.fromJson(json['callSignalElem'] as Map<String, dynamic>),
  redPacketElem: json['redPacketElem'] == null
      ? null
      : RedPacketElem.fromJson(json['redPacketElem'] as Map<String, dynamic>),
  redPacketGrabNotifyElem: json['redPacketGrabNotifyElem'] == null
      ? null
      : RedPacketGrabNotifyElem.fromJson(json['redPacketGrabNotifyElem'] as Map<String, dynamic>),
);
...
Map<String, dynamic> _$MessageToJson(Message instance) => <String, dynamic>{
  ...
  'callSignalElem': instance.callSignalElem?.toJson(),
  'redPacketElem': instance.redPacketElem?.toJson(),
  'redPacketGrabNotifyElem': instance.redPacketGrabNotifyElem?.toJson(),
};
...
const _$MessageTypeEnumMap = {
  ...
  MessageType.callSignal: 124,
  MessageType.redPacket: 125,
  MessageType.redPacketGrabNotify: 126,
