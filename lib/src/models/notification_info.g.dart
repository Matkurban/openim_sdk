...
OANotification _$OANotificationFromJson(Map<String, dynamic> json) => OANotification(
...
Map<String, dynamic> _$OANotificationToJson(OANotification instance) => <String, dynamic>{
...
BaseGroupNotification _$BaseGroupNotificationFromJson(Map<String, dynamic> json) =>
...
GroupNotification _$GroupNotificationFromJson(Map<String, dynamic> json) => GroupNotification(
  ...
  groupOwnerUser: json['groupOwnerUser'] == null
      ? null
      : GroupMembersInfo.fromJson(json['groupOwnerUser'] as Map<String, dynamic>),
...
GroupRightsTransferNoticication _$GroupRightsTransferNoticicationFromJson(
  ...
  newGroupOwner: json['newGroupOwner'] == null
      ? null
      : GroupMembersInfo.fromJson(json['newGroupOwner'] as Map<String, dynamic>),
);
...
BurnAfterReadingNotification _$BurnAfterReadingNotificationFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$BurnAfterReadingNotificationToJson(BurnAfterReadingNotification instance) =>
    <String, dynamic>{
