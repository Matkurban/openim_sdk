...
UpdateFriendsReq _$UpdateFriendsReqFromJson(Map<String, dynamic> json) => UpdateFriendsReq(
  ownerUserID: json['ownerUserID'] as String?,
  friendUserIDs: (json['friendUserIDs'] as List<dynamic>?)?.map((e) => e as String).toList(),
  isPinned: json['isPinned'] as bool?,
  remark: json['remark'] as String?,
  ex: json['ex'] as String?,
);

Map<String, dynamic> _$UpdateFriendsReqToJson(UpdateFriendsReq instance) => <String, dynamic>{
...
ConversationReq _$ConversationReqFromJson(Map<String, dynamic> json) => ConversationReq(
...
Map<String, dynamic> _$ConversationReqToJson(ConversationReq instance) => <String, dynamic>{
