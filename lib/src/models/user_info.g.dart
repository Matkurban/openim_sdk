...
PublicUserInfo _$PublicUserInfoFromJson(Map<String, dynamic> json) => PublicUserInfo(
  userID: json['userID'] as String?,
  nickname: json['nickname'] as String?,
  faceURL: json['faceURL'] as String?,
...
Map<String, dynamic> _$PublicUserInfoToJson(PublicUserInfo instance) => <String, dynamic>{
  'userID': instance.userID,
  'nickname': instance.nickname,
  'faceURL': instance.faceURL,
...
FriendshipInfo _$FriendshipInfoFromJson(Map<String, dynamic> json) =>
    FriendshipInfo(userID: json['userID'] as String?, result: (json['result'] as num?)?.toInt());

Map<String, dynamic> _$FriendshipInfoToJson(FriendshipInfo instance) => <String, dynamic>{
  'userID': instance.userID,
  'result': instance.result,
};

FriendApplicationInfo _$FriendApplicationInfoFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$FriendApplicationInfoToJson(FriendApplicationInfo instance) =>
    <String, dynamic>{
...
UserStatusInfo _$UserStatusInfoFromJson(Map<String, dynamic> json) => UserStatusInfo(
  userID: json['userID'] as String?,
  status: (json['status'] as num?)?.toInt(),
  platformIDs: (json['platformIDs'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList(),
);

Map<String, dynamic> _$UserStatusInfoToJson(UserStatusInfo instance) => <String, dynamic>{
  'userID': instance.userID,
  'status': instance.status,
  'platformIDs': instance.platformIDs,
};

GetFriendApplicationListAsRecipientReq _$GetFriendApplicationListAsRecipientReqFromJson(
...
GetFriendApplicationListAsApplicantReq _$GetFriendApplicationListAsApplicantReqFromJson(
  Map<String, dynamic> json,
