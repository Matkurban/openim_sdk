...
sealed class DbSchema {
  ...
  static final localChatLog = TableSchema(
    ...
    indexes: [
      ...
      const IndexSchema(
        fields: ['conversationID', 'sendTime', 'seq', 'contentType'],
      ),
    ],
  );
