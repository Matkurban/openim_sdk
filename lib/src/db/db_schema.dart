...
sealed class DbSchema {
  ...
  static final localChatLog = TableSchema(
    ...
    indexes: [
      const IndexSchema(fields: ['sendID']),
      const IndexSchema(fields: ['recvID']),
      const IndexSchema(fields: ['groupID']),
      const IndexSchema(fields: ['sessionType']),
      const IndexSchema(fields: ['contentType']),
      const IndexSchema(fields: ['sendTime']),
      const IndexSchema(fields: ['seq']),
      const IndexSchema(fields: ['status']),
    ],
  );
