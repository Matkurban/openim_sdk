...
final $typed_data.Uint8List loginRespDescriptor = $convert.base64Decode(
    'CglMb2dpblJlc3ASIgoMYWRtaW5BY2NvdW50GAEgASgJUgxhZG1pbkFjY291bnQSHgoKYWRtaW'
...
final $typed_data.Uint8List addAdminAccountReqDescriptor = $convert.base64Decode(
    'ChJBZGRBZG1pbkFjY291bnRSZXESGAoHYWNjb3VudBgBIAEoCVIHYWNjb3VudBIaCghwYXNzd2'
...
final $typed_data.Uint8List adminUpdateInfoReqDescriptor = $convert.base64Decode(
    'ChJBZG1pblVwZGF0ZUluZm9SZXESNgoHYWNjb3VudBgBIAEoCzIcLm9wZW5pbS5wcm90b2J1Zi'
...
final $typed_data.Uint8List adminUpdateInfoRespDescriptor = $convert.base64Decode(
    'ChNBZG1pblVwZGF0ZUluZm9SZXNwEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEhoKCG5pY2tuYW'
...
final $typed_data.Uint8List changePasswordReqDescriptor = $convert.base64Decode(
    'ChFDaGFuZ2VQYXNzd29yZFJlcRIaCghwYXNzd29yZBgBIAEoCVIIcGFzc3dvcmQ=');
...
final $typed_data.Uint8List changeAdminPasswordReqDescriptor = $convert.base64Decode(
    'ChZDaGFuZ2VBZG1pblBhc3N3b3JkUmVxEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEigKD2N1cn'
...
final $typed_data.Uint8List delAdminAccountReqDescriptor =
    $convert.base64Decode(
        'ChJEZWxBZG1pbkFjY291bnRSZXESGAoHdXNlcklEcxgBIAMoCVIHdXNlcklEcw==');
...
final $typed_data.Uint8List searchAdminAccountReqDescriptor = $convert.base64Decode(
    'ChVTZWFyY2hBZG1pbkFjY291bnRSZXESPwoKcGFnaW5hdGlvbhgCIAEoCzIfLm9wZW5pbS5zZG'
...
final $typed_data.Uint8List searchAdminAccountRespDescriptor = $convert.base64Decode(
    'ChZTZWFyY2hBZG1pbkFjY291bnRSZXNwEhQKBXRvdGFsGAEgASgNUgV0b3RhbBJECg1hZG1pbk'
...
final $typed_data.Uint8List getAdminInfoRespDescriptor = $convert.base64Decode(
    'ChBHZXRBZG1pbkluZm9SZXNwEhgKB2FjY291bnQYAiABKAlSB2FjY291bnQSGgoIcGFzc3dvcm'
...
final $typed_data.Uint8List addDefaultFriendReqDescriptor =
    $convert.base64Decode(
        'ChNBZGREZWZhdWx0RnJpZW5kUmVxEhgKB3VzZXJJRHMYASADKAlSB3VzZXJJRHM=');
...
final $typed_data.Uint8List delDefaultFriendReqDescriptor =
    $convert.base64Decode(
        'ChNEZWxEZWZhdWx0RnJpZW5kUmVxEhgKB3VzZXJJRHMYASADKAlSB3VzZXJJRHM=');
...
final $typed_data.Uint8List findDefaultFriendRespDescriptor =
    $convert.base64Decode(
        'ChVGaW5kRGVmYXVsdEZyaWVuZFJlc3ASGAoHdXNlcklEcxgBIAMoCVIHdXNlcklEcw==');
...
final $typed_data.Uint8List searchDefaultFriendReqDescriptor = $convert.base64Decode(
    'ChZTZWFyY2hEZWZhdWx0RnJpZW5kUmVxEhgKB2tleXdvcmQYASABKAlSB2tleXdvcmQSPwoKcG'
...
final $typed_data.Uint8List defaultFriendAttributeDescriptor = $convert.base64Decode(
    'ChZEZWZhdWx0RnJpZW5kQXR0cmlidXRlEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEh4KCmNyZW'
...
final $typed_data.Uint8List searchDefaultFriendRespDescriptor = $convert.base64Decode(
    'ChdTZWFyY2hEZWZhdWx0RnJpZW5kUmVzcBIUCgV0b3RhbBgBIAEoDVIFdG90YWwSOgoFdXNlcn'
...
final $typed_data.Uint8List addDefaultGroupReqDescriptor =
    $convert.base64Decode(
        'ChJBZGREZWZhdWx0R3JvdXBSZXESGgoIZ3JvdXBJRHMYASADKAlSCGdyb3VwSURz');
...
final $typed_data.Uint8List delDefaultGroupReqDescriptor =
    $convert.base64Decode(
        'ChJEZWxEZWZhdWx0R3JvdXBSZXESGgoIZ3JvdXBJRHMYASADKAlSCGdyb3VwSURz');
...
final $typed_data.Uint8List findDefaultGroupRespDescriptor =
    $convert.base64Decode(
        'ChRGaW5kRGVmYXVsdEdyb3VwUmVzcBIaCghncm91cElEcxgBIAMoCVIIZ3JvdXBJRHM=');
...
final $typed_data.Uint8List searchDefaultGroupReqDescriptor = $convert.base64Decode(
    'ChVTZWFyY2hEZWZhdWx0R3JvdXBSZXESGAoHa2V5d29yZBgBIAEoCVIHa2V5d29yZBI/CgpwYW'
...
final $typed_data.Uint8List groupAttributeDescriptor = $convert.base64Decode(
    'Cg5Hcm91cEF0dHJpYnV0ZRIYCgdncm91cElEGAEgASgJUgdncm91cElEEh4KCmNyZWF0ZVRpbW'
...
final $typed_data.Uint8List searchDefaultGroupRespDescriptor =
    $convert.base64Decode(
        'ChZTZWFyY2hEZWZhdWx0R3JvdXBSZXNwEhQKBXRvdGFsGAEgASgNUgV0b3RhbBIaCghncm91cE'
...
final $typed_data.Uint8List addInvitationCodeReqDescriptor =
    $convert.base64Decode(
        'ChRBZGRJbnZpdGF0aW9uQ29kZVJlcRIUCgVjb2RlcxgBIAMoCVIFY29kZXM=');
...
final $typed_data.Uint8List genInvitationCodeReqDescriptor = $convert.base64Decode(
    'ChRHZW5JbnZpdGF0aW9uQ29kZVJlcRIQCgNsZW4YASABKAVSA2xlbhIQCgNudW0YAiABKAVSA2'
...
final $typed_data.Uint8List findInvitationCodeReqDescriptor =
    $convert.base64Decode(
        'ChVGaW5kSW52aXRhdGlvbkNvZGVSZXESFAoFY29kZXMYASADKAlSBWNvZGVz');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.openim.admin.InvitationRegister',
      '10': 'codes'
    },
  ],
};
...
final $typed_data.Uint8List findInvitationCodeRespDescriptor =
    $convert.base64Decode(
        'ChZGaW5kSW52aXRhdGlvbkNvZGVSZXNwEjYKBWNvZGVzGAEgAygLMiAub3BlbmltLmFkbWluLk'
...
final $typed_data.Uint8List useInvitationCodeReqDescriptor = $convert.base64Decode(
    'ChRVc2VJbnZpdGF0aW9uQ29kZVJlcRISCgRjb2RlGAEgASgJUgRjb2RlEhYKBnVzZXJJRBgCIA'
    'EoCVIGdXNlcklE');
...
final $typed_data.Uint8List delInvitationCodeReqDescriptor =
    $convert.base64Decode(
        'ChREZWxJbnZpdGF0aW9uQ29kZVJlcRIUCgVjb2RlcxgBIAMoCVIFY29kZXM=');
...
final $typed_data.Uint8List invitationRegisterDescriptor = $convert.base64Decode(
    'ChJJbnZpdGF0aW9uUmVnaXN0ZXISJgoOaW52aXRhdGlvbkNvZGUYASABKAlSDmludml0YXRpb2'
...
final $typed_data.Uint8List searchInvitationCodeReqDescriptor = $convert.base64Decode(
    'ChdTZWFyY2hJbnZpdGF0aW9uQ29kZVJlcRIWCgZzdGF0dXMYASABKAVSBnN0YXR1cxIYCgd1c2'
...
final $typed_data.Uint8List searchInvitationCodeRespDescriptor =
    $convert.base64Decode(
        'ChhTZWFyY2hJbnZpdGF0aW9uQ29kZVJlc3ASFAoFdG90YWwYASABKA1SBXRvdGFsEjQKBGxpc3'
...
final $typed_data.Uint8List searchUserIPLimitLoginReqDescriptor = $convert.base64Decode(
    'ChlTZWFyY2hVc2VySVBMaW1pdExvZ2luUmVxEhgKB2tleXdvcmQYASABKAlSB2tleXdvcmQSPw'
...
final $typed_data.Uint8List limitUserLoginIPDescriptor = $convert.base64Decode(
    'ChBMaW1pdFVzZXJMb2dpbklQEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEg4KAmlwGAIgASgJUg'
...
const SearchUserIPLimitLoginResp$json = {
  ...
  '2': [
    {'1': 'total', '3': 1, '4': 1, '5': 13, '10': 'total'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.openim.admin.LimitUserLoginIP',
      '10': 'limits'
    },
  ],
};
...
final $typed_data.Uint8List searchUserIPLimitLoginRespDescriptor =
    $convert.base64Decode(
        'ChpTZWFyY2hVc2VySVBMaW1pdExvZ2luUmVzcBIUCgV0b3RhbBgBIAEoDVIFdG90YWwSNgoGbG'
...
final $typed_data.Uint8List userIPLimitLoginDescriptor = $convert.base64Decode(
    'ChBVc2VySVBMaW1pdExvZ2luEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEg4KAmlwGAIgASgJUg'
    'JpcA==');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.openim.admin.UserIPLimitLogin',
      '10': 'limits'
    },
  ],
};
...
final $typed_data.Uint8List addUserIPLimitLoginReqDescriptor =
    $convert.base64Decode(
        'ChZBZGRVc2VySVBMaW1pdExvZ2luUmVxEjYKBmxpbWl0cxgBIAMoCzIeLm9wZW5pbS5hZG1pbi'
...
final $typed_data.Uint8List delUserIPLimitLoginReqDescriptor =
    $convert.base64Decode(
        'ChZEZWxVc2VySVBMaW1pdExvZ2luUmVxEjYKBmxpbWl0cxgBIAMoCzIeLm9wZW5pbS5hZG1pbi'
        '5Vc2VySVBMaW1pdExvZ2luUgZsaW1pdHM=');
...
final $typed_data.Uint8List iPForbiddenDescriptor = $convert.base64Decode(
    'CgtJUEZvcmJpZGRlbhIOCgJpcBgBIAEoCVICaXASJAoNbGltaXRSZWdpc3RlchgCIAEoCFINbG'
...
final $typed_data.Uint8List iPForbiddenAddDescriptor = $convert.base64Decode(
    'Cg5JUEZvcmJpZGRlbkFkZBIOCgJpcBgBIAEoCVICaXASJAoNbGltaXRSZWdpc3RlchgCIAEoCF'
...
final $typed_data.Uint8List searchIPForbiddenReqDescriptor = $convert.base64Decode(
    'ChRTZWFyY2hJUEZvcmJpZGRlblJlcRIYCgdrZXl3b3JkGAEgASgJUgdrZXl3b3JkEhYKBnN0YX'
...
final $typed_data.Uint8List searchIPForbiddenRespDescriptor = $convert.base64Decode(
    'ChVTZWFyY2hJUEZvcmJpZGRlblJlc3ASFAoFdG90YWwYASABKA1SBXRvdGFsEjkKCmZvcmJpZG'
...
final $typed_data.Uint8List addIPForbiddenReqDescriptor = $convert.base64Decode(
    'ChFBZGRJUEZvcmJpZGRlblJlcRI8Cgpmb3JiaWRkZW5zGAEgAygLMhwub3BlbmltLmFkbWluLk'
...
final $typed_data.Uint8List delIPForbiddenReqDescriptor = $convert
    .base64Decode('ChFEZWxJUEZvcmJpZGRlblJlcRIQCgNpcHMYASADKAlSA2lwcw==');
...
final $typed_data.Uint8List checkRegisterForbiddenReqDescriptor =
    $convert.base64Decode(
        'ChlDaGVja1JlZ2lzdGVyRm9yYmlkZGVuUmVxEg4KAmlwGAEgASgJUgJpcA==');
...
final $typed_data.Uint8List checkLoginForbiddenReqDescriptor =
    $convert.base64Decode(
        'ChZDaGVja0xvZ2luRm9yYmlkZGVuUmVxEg4KAmlwGAEgASgJUgJpcBIWCgZ1c2VySUQYAiABKA'
        'lSBnVzZXJJRA==');
...
final $typed_data.Uint8List cancellationUserReqDescriptor = $convert.base64Decode(
    'ChNDYW5jZWxsYXRpb25Vc2VyUmVxEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEhYKBnJlYXNvbh'
    'gCIAEoCVIGcmVhc29u');
...
final $typed_data.Uint8List blockUserReqDescriptor = $convert.base64Decode(
    'CgxCbG9ja1VzZXJSZXESFgoGdXNlcklEGAEgASgJUgZ1c2VySUQSFgoGcmVhc29uGAIgASgJUg'
    'ZyZWFzb24=');
...
final $typed_data.Uint8List blockUserRespDescriptor =
    $convert.base64Decode('Cg1CbG9ja1VzZXJSZXNw');
...
final $typed_data.Uint8List unblockUserReqDescriptor = $convert
    .base64Decode('Cg5VbmJsb2NrVXNlclJlcRIYCgd1c2VySURzGAEgAygJUgd1c2VySURz');
...
final $typed_data.Uint8List searchBlockUserReqDescriptor = $convert.base64Decode(
    'ChJTZWFyY2hCbG9ja1VzZXJSZXESGAoHa2V5d29yZBgBIAEoCVIHa2V5d29yZBI/CgpwYWdpbm'
...
final $typed_data.Uint8List blockUserInfoDescriptor = $convert.base64Decode(
    'Cg1CbG9ja1VzZXJJbmZvEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEhgKB2FjY291bnQYAiABKA'
...
final $typed_data.Uint8List searchBlockUserRespDescriptor = $convert.base64Decode(
    'ChNTZWFyY2hCbG9ja1VzZXJSZXNwEhQKBXRvdGFsGAEgASgNUgV0b3RhbBIxCgV1c2VycxgCIA'
...
final $typed_data.Uint8List findUserBlockInfoReqDescriptor =
    $convert.base64Decode(
        'ChRGaW5kVXNlckJsb2NrSW5mb1JlcRIYCgd1c2VySURzGAEgAygJUgd1c2VySURz');
...
final $typed_data.Uint8List blockInfoDescriptor = $convert.base64Decode(
    'CglCbG9ja0luZm8SFgoGdXNlcklEGAEgASgJUgZ1c2VySUQSFgoGcmVhc29uGAIgASgJUgZyZW'
...
final $typed_data.Uint8List findUserBlockInfoRespDescriptor = $convert.base64Decode(
    'ChVGaW5kVXNlckJsb2NrSW5mb1Jlc3ASLwoGYmxvY2tzGAIgAygLMhcub3BlbmltLmFkbWluLk'
...
final $typed_data.Uint8List createTokenReqDescriptor = $convert.base64Decode(
    'Cg5DcmVhdGVUb2tlblJlcRIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBIaCgh1c2VyVHlwZRggIA'
    'EoBVIIdXNlclR5cGU=');
...
final $typed_data.Uint8List createTokenRespDescriptor = $convert
    .base64Decode('Cg9DcmVhdGVUb2tlblJlc3ASFAoFdG9rZW4YASABKAlSBXRva2Vu');
...
final $typed_data.Uint8List parseTokenReqDescriptor = $convert
    .base64Decode('Cg1QYXJzZVRva2VuUmVxEhQKBXRva2VuGAEgASgJUgV0b2tlbg==');
...
final $typed_data.Uint8List parseTokenRespDescriptor = $convert.base64Decode(
    'Cg5QYXJzZVRva2VuUmVzcBIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBIaCgh1c2VyVHlwZRgCIA'
...
final $typed_data.Uint8List invalidateTokenReqDescriptor =
    $convert.base64Decode(
        'ChJJbnZhbGlkYXRlVG9rZW5SZXESFgoGdXNlcklEGAEgASgJUgZ1c2VySUQ=');
...
final $typed_data.Uint8List addAppletReqDescriptor = $convert.base64Decode(
    'CgxBZGRBcHBsZXRSZXESDgoCaWQYASABKAlSAmlkEhIKBG5hbWUYAiABKAlSBG5hbWUSFAoFYX'
...
final $typed_data.Uint8List addAppletRespDescriptor =
    $convert.base64Decode('Cg1BZGRBcHBsZXRSZXNw');
...
final $typed_data.Uint8List delAppletReqDescriptor = $convert.base64Decode(
    'CgxEZWxBcHBsZXRSZXESHAoJYXBwbGV0SWRzGAEgAygJUglhcHBsZXRJZHM=');
...
final $typed_data.Uint8List delAppletRespDescriptor =
    $convert.base64Decode('Cg1EZWxBcHBsZXRSZXNw');
...
final $typed_data.Uint8List updateAppletReqDescriptor = $convert.base64Decode(
    'Cg9VcGRhdGVBcHBsZXRSZXESDgoCaWQYASABKAlSAmlkEjAKBG5hbWUYAiABKAsyHC5vcGVuaW'
...
final $typed_data.Uint8List findAppletReqDescriptor =
    $convert.base64Decode('Cg1GaW5kQXBwbGV0UmVx');
...
final $typed_data.Uint8List findAppletRespDescriptor = $convert.base64Decode(
    'Cg5GaW5kQXBwbGV0UmVzcBI4CgdhcHBsZXRzGAEgAygLMh4ub3BlbmltLmNoYXQuY29tbW9uLk'
...
final $typed_data.Uint8List searchAppletReqDescriptor = $convert.base64Decode(
    'Cg9TZWFyY2hBcHBsZXRSZXESGAoHa2V5d29yZBgBIAEoCVIHa2V5d29yZBI/CgpwYWdpbmF0aW'
...
final $typed_data.Uint8List searchAppletRespDescriptor = $convert.base64Decode(
    'ChBTZWFyY2hBcHBsZXRSZXNwEhQKBXRvdGFsGAEgASgNUgV0b3RhbBI4CgdhcHBsZXRzGAIgAy'
...
final $typed_data.Uint8List setClientConfigReqDescriptor = $convert.base64Decode(
    'ChJTZXRDbGllbnRDb25maWdSZXESRAoGY29uZmlnGAEgAygLMiwub3BlbmltLmFkbWluLlNldE'
...
final $typed_data.Uint8List delClientConfigReqDescriptor = $convert
    .base64Decode('ChJEZWxDbGllbnRDb25maWdSZXESEgoEa2V5cxgBIAMoCVIEa2V5cw==');
...
final $typed_data.Uint8List getClientConfigRespDescriptor = $convert.base64Decode(
    'ChNHZXRDbGllbnRDb25maWdSZXNwEkUKBmNvbmZpZxgBIAMoCzItLm9wZW5pbS5hZG1pbi5HZX'
...
final $typed_data.Uint8List getUserTokenReqDescriptor = $convert
    .base64Decode('Cg9HZXRVc2VyVG9rZW5SZXESFgoGdXNlcklEGAEgASgJUgZ1c2VySUQ=');
...
final $typed_data.Uint8List getUserTokenRespDescriptor = $convert.base64Decode(
    'ChBHZXRVc2VyVG9rZW5SZXNwEksKCXRva2Vuc01hcBgBIAMoCzItLm9wZW5pbS5hZG1pbi5HZX'
...
final $typed_data.Uint8List applicationVersionDescriptor = $convert.base64Decode(
    'ChJBcHBsaWNhdGlvblZlcnNpb24SDgoCaWQYASABKAlSAmlkEhoKCHBsYXRmb3JtGAIgASgJUg'
...
final $typed_data.Uint8List latestApplicationVersionReqDescriptor =
    $convert.base64Decode(
        'ChtMYXRlc3RBcHBsaWNhdGlvblZlcnNpb25SZXESGgoIcGxhdGZvcm0YAiABKAlSCHBsYXRmb3'
...
final $typed_data.Uint8List latestApplicationVersionRespDescriptor =
    $convert.base64Decode(
        'ChxMYXRlc3RBcHBsaWNhdGlvblZlcnNpb25SZXNwEjoKB3ZlcnNpb24YASABKAsyIC5vcGVuaW'
...
final $typed_data.Uint8List addApplicationVersionReqDescriptor = $convert.base64Decode(
    'ChhBZGRBcHBsaWNhdGlvblZlcnNpb25SZXESGgoIcGxhdGZvcm0YASABKAlSCHBsYXRmb3JtEh'
...
final $typed_data.Uint8List updateApplicationVersionReqDescriptor = $convert.base64Decode(
    'ChtVcGRhdGVBcHBsaWNhdGlvblZlcnNpb25SZXESDgoCaWQYASABKAlSAmlkEjgKCHBsYXRmb3'
...
final $typed_data.Uint8List deleteApplicationVersionReqDescriptor =
    $convert.base64Decode(
        'ChtEZWxldGVBcHBsaWNhdGlvblZlcnNpb25SZXESDgoCaWQYASADKAlSAmlk');
...
final $typed_data.Uint8List pageApplicationVersionReqDescriptor = $convert.base64Decode(
    'ChlQYWdlQXBwbGljYXRpb25WZXJzaW9uUmVxEhoKCHBsYXRmb3JtGAEgAygJUghwbGF0Zm9ybR'
...
final $typed_data.Uint8List pageApplicationVersionRespDescriptor =
    $convert.base64Decode(
        'ChpQYWdlQXBwbGljYXRpb25WZXJzaW9uUmVzcBIUCgV0b3RhbBgBIAEoA1IFdG90YWwSPAoIdm'
...
const $core.Map<$core.String, $core.dynamic> adminServiceBase$json = {
  ...
  '2': [
    {
      '1': 'Login',
      '2': '.openim.admin.LoginReq',
      '3': '.openim.admin.LoginResp'
    },
    {
      '1': 'ChangePassword',
    ...
    {
      '1': 'BlockUser',
      '2': '.openim.admin.BlockUserReq',
      '3': '.openim.admin.BlockUserResp'
    },
    {
      '1': 'UnblockUser',
      '2': '.openim.admin.UnblockUserReq',
      '3': '.openim.admin.UnblockUserResp'
    },
    {
      '1': 'SearchBlockUser',
    ...
    {
      '1': 'CreateToken',
      '2': '.openim.admin.CreateTokenReq',
      '3': '.openim.admin.CreateTokenResp'
    },
    {
      '1': 'ParseToken',
      '2': '.openim.admin.ParseTokenReq',
      '3': '.openim.admin.ParseTokenResp'
    },
    {
      '1': 'AddApplet',
      '2': '.openim.admin.AddAppletReq',
      '3': '.openim.admin.AddAppletResp'
    },
    {
      '1': 'DelApplet',
      '2': '.openim.admin.DelAppletReq',
      '3': '.openim.admin.DelAppletResp'
    },
    {
      '1': 'UpdateApplet',
    ...
    {
      '1': 'FindApplet',
      '2': '.openim.admin.FindAppletReq',
      '3': '.openim.admin.FindAppletResp'
    },
    {
      '1': 'SearchApplet',
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
  ...
  '.openim.admin.GetClientConfigResp.ConfigEntry':
      GetClientConfigResp_ConfigEntry$json,
  '.openim.admin.SetClientConfigReq': SetClientConfigReq$json,
  '.openim.admin.SetClientConfigReq.ConfigEntry':
      SetClientConfigReq_ConfigEntry$json,
  ...
  '.openim.admin.GetUserTokenResp.TokensMapEntry':
      GetUserTokenResp_TokensMapEntry$json,
  ...
  '.openim.admin.LatestApplicationVersionResp':
      LatestApplicationVersionResp$json,
  ...
  '.openim.admin.UpdateApplicationVersionResp':
      UpdateApplicationVersionResp$json,
  '.openim.admin.DeleteApplicationVersionReq': DeleteApplicationVersionReq$json,
  '.openim.admin.DeleteApplicationVersionResp':
      DeleteApplicationVersionResp$json,
...
final $typed_data.Uint8List adminServiceDescriptor = $convert.base64Decode(
    'CgVhZG1pbhI4CgVMb2dpbhIWLm9wZW5pbS5hZG1pbi5Mb2dpblJlcRoXLm9wZW5pbS5hZG1pbi'
