...
final $typed_data.Uint8List userFullInfoDescriptor = $convert
    .base64Decode('CgxVc2VyRnVsbEluZm8SFgoGdXNlcklEGAEgASgJUgZ1c2VySUQSGgoIcGFzc3dvcmQYAiABKA'
...
final $typed_data.Uint8List userPublicInfoDescriptor = $convert
    .base64Decode('Cg5Vc2VyUHVibGljSW5mbxIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBIYCgdhY2NvdW50GAIgAS'
...
final $typed_data.Uint8List appletInfoDescriptor = $convert
    .base64Decode('CgpBcHBsZXRJbmZvEg4KAmlkGAEgASgJUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEhQKBWFwcE'
...
final $typed_data.Uint8List logInfoDescriptor = $convert
    .base64Decode('CgdMb2dJbmZvEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEhoKCHBsYXRmb3JtGAIgASgFUghwbG'
