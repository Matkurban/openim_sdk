...
final $typed_data.Uint8List pullOrderDescriptor =
    $convert.base64Decode('CglQdWxsT3JkZXISEAoMUHVsbE9yZGVyQXNjEAASEQoNUHVsbE9yZGVyRGVzYxAB');
...
final $typed_data.Uint8List groupInfoDescriptor = $convert
    .base64Decode('CglHcm91cEluZm8SGAoHZ3JvdXBJRBgBIAEoCVIHZ3JvdXBJRBIcCglncm91cE5hbWUYAiABKA'
...
final $typed_data.Uint8List groupInfoForSetDescriptor = $convert
    .base64Decode('Cg9Hcm91cEluZm9Gb3JTZXQSGAoHZ3JvdXBJRBgBIAEoCVIHZ3JvdXBJRBIcCglncm91cE5hbW'
...
final $typed_data.Uint8List groupMemberFullInfoDescriptor = $convert
    .base64Decode('ChNHcm91cE1lbWJlckZ1bGxJbmZvEhgKB2dyb3VwSUQYASABKAlSB2dyb3VwSUQSFgoGdXNlck'
...
final $typed_data.Uint8List publicUserInfoDescriptor = $convert
    .base64Decode('Cg5QdWJsaWNVc2VySW5mbxIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBIaCghuaWNrbmFtZRgCIA'
...
final $typed_data.Uint8List userInfoDescriptor = $convert
    .base64Decode('CghVc2VySW5mbxIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBIaCghuaWNrbmFtZRgCIAEoCVIIbm'
...
final $typed_data.Uint8List userInfoWithExDescriptor = $convert
    .base64Decode('Cg5Vc2VySW5mb1dpdGhFeBIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBI4CghuaWNrbmFtZRgCIA'
...
const FriendInfo$json = {
  ...
  '2': [
    ...
    {'1': 'friendUser', '3': 4, '4': 1, '5': 11, '6': '.openim.sdkws.UserInfo', '10': 'friendUser'},
...
final $typed_data.Uint8List friendInfoDescriptor = $convert
    .base64Decode('CgpGcmllbmRJbmZvEiAKC293bmVyVXNlcklEGAEgASgJUgtvd25lclVzZXJJRBIWCgZyZW1hcm'
...
final $typed_data.Uint8List blackInfoDescriptor = $convert
    .base64Decode('CglCbGFja0luZm8SIAoLb3duZXJVc2VySUQYASABKAlSC293bmVyVXNlcklEEh4KCmNyZWF0ZV'
...
const GroupRequest$json = {
  ...
  '2': [
    ...
    {'1': 'groupInfo', '3': 2, '4': 1, '5': 11, '6': '.openim.sdkws.GroupInfo', '10': 'groupInfo'},
...
final $typed_data.Uint8List groupRequestDescriptor = $convert
    .base64Decode('CgxHcm91cFJlcXVlc3QSOAoIdXNlckluZm8YASABKAsyHC5vcGVuaW0uc2Rrd3MuUHVibGljVX'
...
final $typed_data.Uint8List friendRequestDescriptor = $convert
    .base64Decode('Cg1GcmllbmRSZXF1ZXN0Eh4KCmZyb21Vc2VySUQYASABKAlSCmZyb21Vc2VySUQSIgoMZnJvbU'
...
const PullMessageBySeqsReq$json = {
  ...
  '2': [
    {'1': 'userID', '3': 1, '4': 1, '5': 9, '10': 'userID'},
    {'1': 'seqRanges', '3': 2, '4': 3, '5': 11, '6': '.openim.sdkws.SeqRange', '10': 'seqRanges'},
    {'1': 'order', '3': 3, '4': 1, '5': 14, '6': '.openim.sdkws.PullOrder', '10': 'order'},
  ],
};

/// Descriptor for `PullMessageBySeqsReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pullMessageBySeqsReqDescriptor = $convert
    .base64Decode('ChRQdWxsTWVzc2FnZUJ5U2Vxc1JlcRIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBI0CglzZXFSYW'
...
final $typed_data.Uint8List seqRangeDescriptor = $convert
    .base64Decode('CghTZXFSYW5nZRImCg5jb252ZXJzYXRpb25JRBgBIAEoCVIOY29udmVyc2F0aW9uSUQSFAoFYm'
...
const PullMsgs$json = {
  '1': 'PullMsgs',
  '2': [
    {'1': 'Msgs', '3': 1, '4': 3, '5': 11, '6': '.openim.sdkws.MsgData', '10': 'Msgs'},
    {'1': 'isEnd', '3': 2, '4': 1, '5': 8, '10': 'isEnd'},
  ],
};

/// Descriptor for `PullMsgs`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pullMsgsDescriptor = $convert
    .base64Decode('CghQdWxsTXNncxIpCgRNc2dzGAEgAygLMhUub3BlbmltLnNka3dzLk1zZ0RhdGFSBE1zZ3MSFA'
...
const PullMessageBySeqsResp_MsgsEntry$json = {
  ...
  '2': [
    ...
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.openim.sdkws.PullMsgs', '10': 'value'},
  ],
  '7': {'7': true},
};
...
final $typed_data.Uint8List pullMessageBySeqsRespDescriptor = $convert
    .base64Decode('ChVQdWxsTWVzc2FnZUJ5U2Vxc1Jlc3ASQQoEbXNncxgBIAMoCzItLm9wZW5pbS5zZGt3cy5QdW'
...
final $typed_data.Uint8List getMaxSeqReqDescriptor =
    $convert.base64Decode('CgxHZXRNYXhTZXFSZXESFgoGdXNlcklEGAEgASgJUgZ1c2VySUQ=');
...
final $typed_data.Uint8List getMaxSeqRespDescriptor = $convert
    .base64Decode('Cg1HZXRNYXhTZXFSZXNwEkIKB21heFNlcXMYASADKAsyKC5vcGVuaW0uc2Rrd3MuR2V0TWF4U2'
...
final $typed_data.Uint8List userSendMsgRespDescriptor = $convert
    .base64Decode('Cg9Vc2VyU2VuZE1zZ1Jlc3ASIAoLc2VydmVyTXNnSUQYASABKAlSC3NlcnZlck1zZ0lEEiAKC2'
...
final $typed_data.Uint8List msgDataDescriptor = $convert
    .base64Decode('CgdNc2dEYXRhEhYKBnNlbmRJRBgBIAEoCVIGc2VuZElEEhYKBnJlY3ZJRBgCIAEoCVIGcmVjdk'
...
final $typed_data.Uint8List pushMessagesDescriptor = $convert
    .base64Decode('CgxQdXNoTWVzc2FnZXMSOAoEbXNncxgBIAMoCzIkLm9wZW5pbS5zZGt3cy5QdXNoTWVzc2FnZX'
...
final $typed_data.Uint8List offlinePushInfoDescriptor = $convert
    .base64Decode('Cg9PZmZsaW5lUHVzaEluZm8SFAoFdGl0bGUYASABKAlSBXRpdGxlEhIKBGRlc2MYAiABKAlSBG'
...
final $typed_data.Uint8List tipsCommDescriptor = $convert
    .base64Decode('CghUaXBzQ29tbRIWCgZkZXRhaWwYASABKAxSBmRldGFpbBIgCgtkZWZhdWx0VGlwcxgCIAEoCV'
...
const GroupCreatedTips$json = {
  '1': 'GroupCreatedTips',
  '2': [
    {'1': 'group', '3': 1, '4': 1, '5': 11, '6': '.openim.sdkws.GroupInfo', '10': 'group'},
    {
      '1': 'opUser',
      '3': 2,
      '4': 1,
...
final $typed_data.Uint8List groupCreatedTipsDescriptor = $convert
    .base64Decode('ChBHcm91cENyZWF0ZWRUaXBzEi0KBWdyb3VwGAEgASgLMhcub3BlbmltLnNka3dzLkdyb3VwSW'
...
final $typed_data.Uint8List groupInfoSetTipsDescriptor = $convert
    .base64Decode('ChBHcm91cEluZm9TZXRUaXBzEjkKBm9wVXNlchgBIAEoCzIhLm9wZW5pbS5zZGt3cy5Hcm91cE'
...
const GroupInfoSetNameTips$json = {
  ...
  '2': [
    ...
    {'1': 'group', '3': 2, '4': 1, '5': 11, '6': '.openim.sdkws.GroupInfo', '10': 'group'},
  ],
};

/// Descriptor for `GroupInfoSetNameTips`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List groupInfoSetNameTipsDescriptor = $convert
    .base64Decode('ChRHcm91cEluZm9TZXROYW1lVGlwcxI5CgZvcFVzZXIYASABKAsyIS5vcGVuaW0uc2Rrd3MuR3'
...
final $typed_data.Uint8List groupInfoSetAnnouncementTipsDescriptor = $convert
    .base64Decode('ChxHcm91cEluZm9TZXRBbm5vdW5jZW1lbnRUaXBzEjkKBm9wVXNlchgBIAEoCzIhLm9wZW5pbS'
...
final $typed_data.Uint8List joinGroupApplicationTipsDescriptor = $convert
    .base64Decode('ChhKb2luR3JvdXBBcHBsaWNhdGlvblRpcHMSLQoFZ3JvdXAYASABKAsyFy5vcGVuaW0uc2Rrd3'
...
final $typed_data.Uint8List memberQuitTipsDescriptor = $convert
    .base64Decode('Cg5NZW1iZXJRdWl0VGlwcxItCgVncm91cBgBIAEoCzIXLm9wZW5pbS5zZGt3cy5Hcm91cEluZm'
...
final $typed_data.Uint8List groupApplicationAcceptedTipsDescriptor = $convert
    .base64Decode('ChxHcm91cEFwcGxpY2F0aW9uQWNjZXB0ZWRUaXBzEi0KBWdyb3VwGAEgASgLMhcub3BlbmltLn'
...
final $typed_data.Uint8List groupApplicationRejectedTipsDescriptor = $convert
    .base64Decode('ChxHcm91cEFwcGxpY2F0aW9uUmVqZWN0ZWRUaXBzEi0KBWdyb3VwGAEgASgLMhcub3BlbmltLn'
        'Nka3dzLkdyb3VwSW5mb1IFZ3JvdXASOQoGb3BVc2VyGAIgASgLMiEub3BlbmltLnNka3dzLkdy'
        'b3VwTWVtYmVyRnVsbEluZm9SBm9wVXNlchIcCgloYW5kbGVNc2cYBCABKAlSCWhhbmRsZU1zZx'
        'IeCgpyZWNlaXZlckFzGAUgASgFUgpyZWNlaXZlckFz');
...
final $typed_data.Uint8List groupOwnerTransferredTipsDescriptor = $convert
    .base64Decode('ChlHcm91cE93bmVyVHJhbnNmZXJyZWRUaXBzEi0KBWdyb3VwGAEgASgLMhcub3BlbmltLnNka3'
...
final $typed_data.Uint8List memberKickedTipsDescriptor = $convert
    .base64Decode('ChBNZW1iZXJLaWNrZWRUaXBzEi0KBWdyb3VwGAEgASgLMhcub3BlbmltLnNka3dzLkdyb3VwSW'
        '5mb1IFZ3JvdXASOQoGb3BVc2VyGAIgASgLMiEub3BlbmltLnNka3dzLkdyb3VwTWVtYmVyRnVs'
...
final $typed_data.Uint8List memberInvitedTipsDescriptor = $convert
    .base64Decode('ChFNZW1iZXJJbnZpdGVkVGlwcxItCgVncm91cBgBIAEoCzIXLm9wZW5pbS5zZGt3cy5Hcm91cE'
...
final $typed_data.Uint8List memberEnterTipsDescriptor = $convert
    .base64Decode('Cg9NZW1iZXJFbnRlclRpcHMSLQoFZ3JvdXAYASABKAsyFy5vcGVuaW0uc2Rrd3MuR3JvdXBJbm'
...
final $typed_data.Uint8List groupDismissedTipsDescriptor = $convert
    .base64Decode('ChJHcm91cERpc21pc3NlZFRpcHMSLQoFZ3JvdXAYASABKAsyFy5vcGVuaW0uc2Rrd3MuR3JvdX'
...
final $typed_data.Uint8List groupMemberMutedTipsDescriptor = $convert
    .base64Decode('ChRHcm91cE1lbWJlck11dGVkVGlwcxItCgVncm91cBgBIAEoCzIXLm9wZW5pbS5zZGt3cy5Hcm'
...
final $typed_data.Uint8List groupMemberCancelMutedTipsDescriptor = $convert
    .base64Decode('ChpHcm91cE1lbWJlckNhbmNlbE11dGVkVGlwcxItCgVncm91cBgBIAEoCzIXLm9wZW5pbS5zZG'
...
final $typed_data.Uint8List groupMutedTipsDescriptor = $convert
    .base64Decode('Cg5Hcm91cE11dGVkVGlwcxItCgVncm91cBgBIAEoCzIXLm9wZW5pbS5zZGt3cy5Hcm91cEluZm'
...
final $typed_data.Uint8List groupCancelMutedTipsDescriptor = $convert
    .base64Decode('ChRHcm91cENhbmNlbE11dGVkVGlwcxItCgVncm91cBgBIAEoCzIXLm9wZW5pbS5zZGt3cy5Hcm'
        '91cEluZm9SBWdyb3VwEjkKBm9wVXNlchgCIAEoCzIhLm9wZW5pbS5zZGt3cy5Hcm91cE1lbWJl'
...
final $typed_data.Uint8List groupMemberInfoSetTipsDescriptor = $convert
    .base64Decode('ChZHcm91cE1lbWJlckluZm9TZXRUaXBzEi0KBWdyb3VwGAEgASgLMhcub3BlbmltLnNka3dzLk'
...
final $typed_data.Uint8List friendApplicationDescriptor = $convert
    .base64Decode('ChFGcmllbmRBcHBsaWNhdGlvbhIYCgdhZGRUaW1lGAEgASgDUgdhZGRUaW1lEhwKCWFkZFNvdX'
...
final $typed_data.Uint8List fromToUserIDDescriptor = $convert
    .base64Decode('CgxGcm9tVG9Vc2VySUQSHgoKZnJvbVVzZXJJRBgBIAEoCVIKZnJvbVVzZXJJRBIaCgh0b1VzZX'
...
final $typed_data.Uint8List friendApplicationTipsDescriptor = $convert
    .base64Decode('ChVGcmllbmRBcHBsaWNhdGlvblRpcHMSPgoMZnJvbVRvVXNlcklEGAEgASgLMhoub3BlbmltLn'
...
final $typed_data.Uint8List friendApplicationApprovedTipsDescriptor = $convert
    .base64Decode('Ch1GcmllbmRBcHBsaWNhdGlvbkFwcHJvdmVkVGlwcxI+Cgxmcm9tVG9Vc2VySUQYASABKAsyGi'
...
final $typed_data.Uint8List friendApplicationRejectedTipsDescriptor = $convert
    .base64Decode('Ch1GcmllbmRBcHBsaWNhdGlvblJlamVjdGVkVGlwcxI+Cgxmcm9tVG9Vc2VySUQYASABKAsyGi'
        '5vcGVuaW0uc2Rrd3MuRnJvbVRvVXNlcklEUgxmcm9tVG9Vc2VySUQSHAoJaGFuZGxlTXNnGAIg'
        'ASgJUgloYW5kbGVNc2c=');
...
const FriendAddedTips$json = {
  '1': 'FriendAddedTips',
  '2': [
    {'1': 'friend', '3': 1, '4': 1, '5': 11, '6': '.openim.sdkws.FriendInfo', '10': 'friend'},
    {'1': 'operationTime', '3': 2, '4': 1, '5': 3, '10': 'operationTime'},
    {'1': 'opUser', '3': 3, '4': 1, '5': 11, '6': '.openim.sdkws.PublicUserInfo', '10': 'opUser'},
  ],
};

/// Descriptor for `FriendAddedTips`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List friendAddedTipsDescriptor = $convert
    .base64Decode('Cg9GcmllbmRBZGRlZFRpcHMSMAoGZnJpZW5kGAEgASgLMhgub3BlbmltLnNka3dzLkZyaWVuZE'
...
final $typed_data.Uint8List friendDeletedTipsDescriptor = $convert
    .base64Decode('ChFGcmllbmREZWxldGVkVGlwcxI+Cgxmcm9tVG9Vc2VySUQYASABKAsyGi5vcGVuaW0uc2Rrd3'
...
final $typed_data.Uint8List blackAddedTipsDescriptor = $convert
    .base64Decode('Cg5CbGFja0FkZGVkVGlwcxI+Cgxmcm9tVG9Vc2VySUQYASABKAsyGi5vcGVuaW0uc2Rrd3MuRn'
...
final $typed_data.Uint8List blackDeletedTipsDescriptor = $convert
    .base64Decode('ChBCbGFja0RlbGV0ZWRUaXBzEj4KDGZyb21Ub1VzZXJJRBgBIAEoCzIaLm9wZW5pbS5zZGt3cy'
...
final $typed_data.Uint8List friendInfoChangedTipsDescriptor = $convert
    .base64Decode('ChVGcmllbmRJbmZvQ2hhbmdlZFRpcHMSPgoMZnJvbVRvVXNlcklEGAEgASgLMhoub3BlbmltLn'
        'Nka3dzLkZyb21Ub1VzZXJJRFIMZnJvbVRvVXNlcklE');
...
final $typed_data.Uint8List userInfoUpdatedTipsDescriptor =
    $convert.base64Decode('ChNVc2VySW5mb1VwZGF0ZWRUaXBzEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklE');
...
final $typed_data.Uint8List userStatusChangeTipsDescriptor = $convert
    .base64Decode('ChRVc2VyU3RhdHVzQ2hhbmdlVGlwcxIeCgpmcm9tVXNlcklEGAEgASgJUgpmcm9tVXNlcklEEh'
...
final $typed_data.Uint8List userCommandAddTipsDescriptor = $convert
    .base64Decode('ChJVc2VyQ29tbWFuZEFkZFRpcHMSHgoKZnJvbVVzZXJJRBgBIAEoCVIKZnJvbVVzZXJJRBIaCg'
...
final $typed_data.Uint8List userCommandUpdateTipsDescriptor = $convert
    .base64Decode('ChVVc2VyQ29tbWFuZFVwZGF0ZVRpcHMSHgoKZnJvbVVzZXJJRBgBIAEoCVIKZnJvbVVzZXJJRB'
...
final $typed_data.Uint8List userCommandDeleteTipsDescriptor = $convert
    .base64Decode('ChVVc2VyQ29tbWFuZERlbGV0ZVRpcHMSHgoKZnJvbVVzZXJJRBgBIAEoCVIKZnJvbVVzZXJJRB'
        'IaCgh0b1VzZXJJRBgCIAEoCVIIdG9Vc2VySUQ=');
...
final $typed_data.Uint8List conversationUpdateTipsDescriptor = $convert
    .base64Decode('ChZDb252ZXJzYXRpb25VcGRhdGVUaXBzEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEi4KEmNvbn'
...
final $typed_data.Uint8List conversationSetPrivateTipsDescriptor = $convert
    .base64Decode('ChpDb252ZXJzYXRpb25TZXRQcml2YXRlVGlwcxIWCgZyZWN2SUQYASABKAlSBnJlY3ZJRBIWCg'
...
final $typed_data.Uint8List conversationHasReadTipsDescriptor = $convert
    .base64Decode('ChdDb252ZXJzYXRpb25IYXNSZWFkVGlwcxIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBImCg5jb2'
...
final $typed_data.Uint8List notificationElemDescriptor =
    $convert.base64Decode('ChBOb3RpZmljYXRpb25FbGVtEhYKBmRldGFpbBgBIAEoCVIGZGV0YWls');
...
final $typed_data.Uint8List deleteMessageTipsDescriptor = $convert
    .base64Decode('ChFEZWxldGVNZXNzYWdlVGlwcxIaCghvcFVzZXJJRBgBIAEoCVIIb3BVc2VySUQSFgoGdXNlck'
...
final $typed_data.Uint8List revokeMsgTipsDescriptor = $convert
    .base64Decode('Cg1SZXZva2VNc2dUaXBzEiQKDXJldm9rZXJVc2VySUQYASABKAlSDXJldm9rZXJVc2VySUQSIA'
...
final $typed_data.Uint8List messageRevokedContentDescriptor = $convert
    .base64Decode('ChVNZXNzYWdlUmV2b2tlZENvbnRlbnQSHAoJcmV2b2tlcklEGAEgASgJUglyZXZva2VySUQSIA'
...
final $typed_data.Uint8List clearConversationTipsDescriptor = $convert
    .base64Decode('ChVDbGVhckNvbnZlcnNhdGlvblRpcHMSFgoGdXNlcklEGAEgASgJUgZ1c2VySUQSKAoPY29udm'
...
final $typed_data.Uint8List deleteMsgsTipsDescriptor = $convert
    .base64Decode('Cg5EZWxldGVNc2dzVGlwcxIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBImCg5jb252ZXJzYXRpb2'
...
final $typed_data.Uint8List markAsReadTipsDescriptor = $convert
    .base64Decode('Cg5NYXJrQXNSZWFkVGlwcxIqChBtYXJrQXNSZWFkVXNlcklEGAEgASgJUhBtYXJrQXNSZWFkVX'
...
final $typed_data.Uint8List setAppBackgroundStatusReqDescriptor = $convert
    .base64Decode('ChlTZXRBcHBCYWNrZ3JvdW5kU3RhdHVzUmVxEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEiIKDG'
...
final $typed_data.Uint8List processUserCommandDescriptor = $convert
    .base64Decode('ChJQcm9jZXNzVXNlckNvbW1hbmQSFgoGdXNlcklEGAEgASgJUgZ1c2VySUQSEgoEdHlwZRgCIA'
...
final $typed_data.Uint8List requestPaginationDescriptor = $convert
    .base64Decode('ChFSZXF1ZXN0UGFnaW5hdGlvbhIeCgpwYWdlTnVtYmVyGAEgASgFUgpwYWdlTnVtYmVyEh4KCn'
...
final $typed_data.Uint8List friendsInfoUpdateTipsDescriptor = $convert
    .base64Decode('ChVGcmllbmRzSW5mb1VwZGF0ZVRpcHMSPgoMZnJvbVRvVXNlcklEGAEgASgLMhoub3BlbmltLn'
