...
final $typed_data.Uint8List userIdentityDescriptor = $convert
    .base64Decode('CgxVc2VySWRlbnRpdHkSFAoFZW1haWwYASABKAlSBWVtYWlsEhoKCGFyZWFDb2RlGAIgASgJUg'
...
final $typed_data.Uint8List updateUserInfoReqDescriptor = $convert
    .base64Decode('ChFVcGRhdGVVc2VySW5mb1JlcRIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBI2CgdhY2NvdW50GA'
...
final $typed_data.Uint8List updateUserInfoRespDescriptor = $convert
    .base64Decode('ChJVcGRhdGVVc2VySW5mb1Jlc3ASGAoHZmFjZVVybBgBIAEoCVIHZmFjZVVybBIaCghuaWNrTm'
...
final $typed_data.Uint8List findUserPublicInfoReqDescriptor =
    $convert.base64Decode('ChVGaW5kVXNlclB1YmxpY0luZm9SZXESGAoHdXNlcklEcxgBIAMoCVIHdXNlcklEcw==');
...
final $typed_data.Uint8List findUserPublicInfoRespDescriptor = $convert
    .base64Decode('ChZGaW5kVXNlclB1YmxpY0luZm9SZXNwEjgKBXVzZXJzGAEgAygLMiIub3BlbmltLmNoYXQuY2'
...
final $typed_data.Uint8List searchUserPublicInfoReqDescriptor = $convert
    .base64Decode('ChdTZWFyY2hVc2VyUHVibGljSW5mb1JlcRIYCgdrZXl3b3JkGAEgASgJUgdrZXl3b3JkEj8KCn'
...
final $typed_data.Uint8List searchUserPublicInfoRespDescriptor = $convert
    .base64Decode('ChhTZWFyY2hVc2VyUHVibGljSW5mb1Jlc3ASFAoFdG90YWwYASABKA1SBXRvdGFsEjgKBXVzZX'
...
final $typed_data.Uint8List findUserFullInfoReqDescriptor =
    $convert.base64Decode('ChNGaW5kVXNlckZ1bGxJbmZvUmVxEhgKB3VzZXJJRHMYASADKAlSB3VzZXJJRHM=');

@$core.Deprecated('Use findUserFullInfoRespDescriptor instead')
const FindUserFullInfoResp$json = {
  '1': 'FindUserFullInfoResp',
  '2': [
    {'1': 'users', '3': 1, '4': 3, '5': 11, '6': '.openim.chat.common.UserFullInfo', '10': 'users'},
  ],
};

/// Descriptor for `FindUserFullInfoResp`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List findUserFullInfoRespDescriptor = $convert
    .base64Decode('ChRGaW5kVXNlckZ1bGxJbmZvUmVzcBI2CgV1c2VycxgBIAMoCzIgLm9wZW5pbS5jaGF0LmNvbW'
...
final $typed_data.Uint8List sendVerifyCodeReqDescriptor = $convert
    .base64Decode('ChFTZW5kVmVyaWZ5Q29kZVJlcRIYCgd1c2VkRm9yGAEgASgFUgd1c2VkRm9yEg4KAmlwGAIgAS'
...
final $typed_data.Uint8List verifyCodeReqDescriptor = $convert
    .base64Decode('Cg1WZXJpZnlDb2RlUmVxEhoKCGFyZWFDb2RlGAEgASgJUghhcmVhQ29kZRIgCgtwaG9uZU51bW'
...
final $typed_data.Uint8List registerUserInfoDescriptor = $convert
    .base64Decode('ChBSZWdpc3RlclVzZXJJbmZvEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEhoKCG5pY2tuYW1lGA'
...
const RegisterUserReq$json = {
  ...
  '2': [
    ...
    {'1': 'user', '3': 7, '4': 1, '5': 11, '6': '.openim.chat.RegisterUserInfo', '10': 'user'},
  ],
};

/// Descriptor for `RegisterUserReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List registerUserReqDescriptor = $convert
    .base64Decode('Cg9SZWdpc3RlclVzZXJSZXESJgoOaW52aXRhdGlvbkNvZGUYASABKAlSDmludml0YXRpb25Db2'
...
final $typed_data.Uint8List registerUserRespDescriptor = $convert
    .base64Decode('ChBSZWdpc3RlclVzZXJSZXNwEhYKBnVzZXJJRBgBIAEoCVIGdXNlcklEEhwKCWNoYXRUb2tlbh'
...
const AddUserAccountReq$json = {
  ...
  '2': [
    ...
    {'1': 'user', '3': 4, '4': 1, '5': 11, '6': '.openim.chat.RegisterUserInfo', '10': 'user'},
  ],
};

/// Descriptor for `AddUserAccountReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addUserAccountReqDescriptor = $convert
    .base64Decode('ChFBZGRVc2VyQWNjb3VudFJlcRIOCgJpcBgBIAEoCVICaXASGgoIZGV2aWNlSUQYAiABKAlSCG'
...
final $typed_data.Uint8List loginReqDescriptor = $convert
    .base64Decode('CghMb2dpblJlcRIaCghhcmVhQ29kZRgBIAEoCVIIYXJlYUNvZGUSIAoLcGhvbmVOdW1iZXIYAi'
...
final $typed_data.Uint8List resetPasswordReqDescriptor = $convert
    .base64Decode('ChBSZXNldFBhc3N3b3JkUmVxEhoKCGFyZWFDb2RlGAEgASgJUghhcmVhQ29kZRIgCgtwaG9uZU'
...
final $typed_data.Uint8List changePasswordReqDescriptor = $convert
    .base64Decode('ChFDaGFuZ2VQYXNzd29yZFJlcRIWCgZ1c2VySUQYASABKAlSBnVzZXJJRBIoCg9jdXJyZW50UG'
...
final $typed_data.Uint8List findUserAccountReqDescriptor =
    $convert.base64Decode('ChJGaW5kVXNlckFjY291bnRSZXESGAoHdXNlcklEcxgBIAMoCVIHdXNlcklEcw==');
...
final $typed_data.Uint8List findUserAccountRespDescriptor = $convert
    .base64Decode('ChNGaW5kVXNlckFjY291bnRSZXNwElwKDnVzZXJBY2NvdW50TWFwGAEgAygLMjQub3BlbmltLm'
...
final $typed_data.Uint8List findAccountUserReqDescriptor =
    $convert.base64Decode('ChJGaW5kQWNjb3VudFVzZXJSZXESGgoIYWNjb3VudHMYASADKAlSCGFjY291bnRz');
...
final $typed_data.Uint8List findAccountUserRespDescriptor = $convert
    .base64Decode('ChNGaW5kQWNjb3VudFVzZXJSZXNwElwKDmFjY291bnRVc2VyTWFwGAEgAygLMjQub3BlbmltLm'
...
final $typed_data.Uint8List signalRecordDescriptor = $convert
    .base64Decode('CgxTaWduYWxSZWNvcmQSGgoIZmlsZU5hbWUYASABKAlSCGZpbGVOYW1lEhwKCW1lZGlhVHlwZR'
...
final $typed_data.Uint8List openIMCallbackReqDescriptor = $convert
    .base64Decode('ChFPcGVuSU1DYWxsYmFja1JlcRIYCgdjb21tYW5kGAEgASgJUgdjb21tYW5kEhIKBGJvZHkYAi'
        'ABKAlSBGJvZHk=');
...
final $typed_data.Uint8List searchUserFullInfoReqDescriptor = $convert
    .base64Decode('ChVTZWFyY2hVc2VyRnVsbEluZm9SZXESGAoHa2V5d29yZBgBIAEoCVIHa2V5d29yZBI/CgpwYW'
...
const SearchUserFullInfoResp$json = {
  ...
  '2': [
    {'1': 'total', '3': 1, '4': 1, '5': 13, '10': 'total'},
    {'1': 'users', '3': 2, '4': 3, '5': 11, '6': '.openim.chat.common.UserFullInfo', '10': 'users'},
  ],
};

/// Descriptor for `SearchUserFullInfoResp`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List searchUserFullInfoRespDescriptor = $convert
    .base64Decode('ChZTZWFyY2hVc2VyRnVsbEluZm9SZXNwEhQKBXRvdGFsGAEgASgNUgV0b3RhbBI2CgV1c2Vycx'
...
final $typed_data.Uint8List userLoginCountReqDescriptor = $convert
    .base64Decode('ChFVc2VyTG9naW5Db3VudFJlcRIUCgVzdGFydBgBIAEoA1IFc3RhcnQSEAoDZW5kGAIgASgDUg'
        'NlbmQ=');
...
final $typed_data.Uint8List userLoginCountRespDescriptor = $convert
    .base64Decode('ChJVc2VyTG9naW5Db3VudFJlc3ASHgoKbG9naW5Db3VudBgBIAEoA1IKbG9naW5Db3VudBIiCg'
...
final $typed_data.Uint8List loginRespDescriptor = $convert
    .base64Decode('CglMb2dpblJlc3ASHAoJY2hhdFRva2VuGAIgASgJUgljaGF0VG9rZW4SFgoGdXNlcklEGAMgAS'
        'gJUgZ1c2VySUQ=');
...
final $typed_data.Uint8List searchUserInfoReqDescriptor = $convert
    .base64Decode('ChFTZWFyY2hVc2VySW5mb1JlcRIYCgdrZXl3b3JkGAEgASgJUgdrZXl3b3JkEj8KCnBhZ2luYX'
...
final $typed_data.Uint8List searchUserInfoRespDescriptor = $convert
    .base64Decode('ChJTZWFyY2hVc2VySW5mb1Jlc3ASFAoFdG90YWwYASABKA1SBXRvdGFsEjYKBXVzZXJzGAIgAy'
...
final $typed_data.Uint8List getTokenForVideoMeetingReqDescriptor = $convert
    .base64Decode('ChpHZXRUb2tlbkZvclZpZGVvTWVldGluZ1JlcRISCgRyb29tGAEgASgJUgRyb29tEhoKCGlkZW'
...
final $typed_data.Uint8List getTokenForVideoMeetingRespDescriptor = $convert
    .base64Decode('ChtHZXRUb2tlbkZvclZpZGVvTWVldGluZ1Jlc3ASHAoJc2VydmVyVXJsGAEgASgJUglzZXJ2ZX'
...
final $typed_data.Uint8List getRTCTokenReqDescriptor = $convert
    .base64Decode('Cg5HZXRSVENUb2tlblJlcRIWCgZyb29tSWQYASABKAlSBnJvb21JZBIWCgZ1c2VySWQYAiABKA'
...
final $typed_data.Uint8List getRTCTokenRespDescriptor = $convert
    .base64Decode('Cg9HZXRSVENUb2tlblJlc3ASFAoFdG9rZW4YASABKAlSBXRva2VuEhQKBWFwcElkGAIgASgJUg'
...
const CheckUserExistReq$json = {
  '1': 'CheckUserExistReq',
  '2': [
    {'1': 'user', '3': 1, '4': 1, '5': 11, '6': '.openim.chat.RegisterUserInfo', '10': 'user'},
  ],
};

/// Descriptor for `CheckUserExistReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List checkUserExistReqDescriptor = $convert
    .base64Decode('ChFDaGVja1VzZXJFeGlzdFJlcRIxCgR1c2VyGAEgASgLMh0ub3BlbmltLmNoYXQuUmVnaXN0ZX'
...
final $typed_data.Uint8List checkUserExistRespDescriptor = $convert
    .base64Decode('ChJDaGVja1VzZXJFeGlzdFJlc3ASFgoGdXNlcmlkGAEgASgJUgZ1c2VyaWQSIgoMaXNSZWdpc3'
...
final $typed_data.Uint8List delUserAccountReqDescriptor =
    $convert.base64Decode('ChFEZWxVc2VyQWNjb3VudFJlcRIYCgd1c2VySURzGAEgAygJUgd1c2VySURz');
...
final $typed_data.Uint8List setAllowRegisterReqDescriptor = $convert
    .base64Decode('ChNTZXRBbGxvd1JlZ2lzdGVyUmVxEiQKDWFsbG93UmVnaXN0ZXIYASABKAhSDWFsbG93UmVnaX'
        'N0ZXI=');
...
final $typed_data.Uint8List getAllowRegisterRespDescriptor = $convert
    .base64Decode('ChRHZXRBbGxvd1JlZ2lzdGVyUmVzcBIkCg1hbGxvd1JlZ2lzdGVyGAEgASgIUg1hbGxvd1JlZ2'
        'lzdGVy');
...
const $core.Map<$core.String, $core.dynamic> chatServiceBase$json = {
  ...
  '2': [
    ...
    {'1': 'VerifyCode', '2': '.openim.chat.VerifyCodeReq', '3': '.openim.chat.VerifyCodeResp'},
    {
      '1': 'RegisterUser',
    ...
    {'1': 'GetRTCToken', '2': '.openim.chat.GetRTCTokenReq', '3': '.openim.chat.GetRTCTokenResp'},
    {
      '1': 'SetAllowRegister',
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> chatServiceBase$messageJson =
  ...
  '.openim.chat.UserLoginCountResp.CountEntry': UserLoginCountResp_CountEntry$json,
...
final $typed_data.Uint8List chatServiceDescriptor = $convert
    .base64Decode('CgRjaGF0ElEKDlVwZGF0ZVVzZXJJbmZvEh4ub3BlbmltLmNoYXQuVXBkYXRlVXNlckluZm9SZX'
